            ...
            VStack(spacing: 0) {
                if authViewModel.isAuthenticated {
                    ZStack {
                        ...
                        VStack(spacing: 0) {
                            // CHANGE: Simplified image loading, removed profileImage dependency
