...
struct UserProfileView: View {
    ...
    private func resetPassword() {
        guard let email = viewModel.user?.email else {
            ...
            resetPasswordMessage = "Email not available. Please try again later."
        ...
        Task {
            do {
                ...
                resetPasswordMessage = "A password reset link has been sent to your email (\(email)). Please log in with your new password!"
                showResetPasswordAlert = true
