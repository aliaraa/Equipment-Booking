...
//                            ProfileMenuItem(icon: "person.fill.questionmark", text: "Is Anonymous: \(isAnonymous.description.capitalized)", action: <#() -> Void#>)
//                        }
//                        
//                        Button {
//                            viewModel.toggleAdminStatus()
//                        } label: {
//                            ProfileMenuItem(icon: "person.fill.checkmark", text: "User is Admin: \((user.isAdmin ?? false).description.capitalized)", action: <#() -> Void#>)
//                        }
//                        
